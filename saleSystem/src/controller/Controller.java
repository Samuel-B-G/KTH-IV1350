...
/**
 * This class represents the main controller which handles calls to functions in other layers.
 */
...
public class Controller {
	...
	/**
	 * Creates a new instance, representing the details of the controller, gathers the required systems and databases from the {@link DatabaseCreator}.
	 *
	 *@param creator The {@link DatabaseCreator} object used to gather the databases.
	 */
	...
	/**
	 * Sends a {@link DiscountDatabase} object to an active sale to be scanned for possible discounts.
	 * 
	...
	/**
	 * Accepts a payment from a customer and updates the inventory and accounting systems, then prints receipt and presents change.
	 * 
