...
public class InventorySystem {
	...
	/**
	 * Adds an item to the storedItems list in the object. This is a temporary function.
	 * 
	...
	/**
	 * Fills the objects storedItems list with several predefined items. This is a temporary function.
	 */
	...
	/**
	 * Searches the objects storedItems list for a specific item and returns its {@link ItemInfoDTO}.
	 * 
	...
	/**
	 * Searches the objects storedItems list for a specific item and returns its quantity.
	 * 
	 * @param itemIdentifier The item identifier to look for in the list.
	 * 
	...
	/**
	 * Accepts an array of ItemDTOs which are used to decrease the stored quantities of the sold items.
	 * 
