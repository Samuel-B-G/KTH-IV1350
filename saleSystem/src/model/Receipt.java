...
public final class Receipt {
	 ...
	 * 
	 * @param saleDTO The DTO containing the details of the sale and the items linked to it.
	...
	Receipt(SaleDTO saleDTO, double paidAmount, double change, String timeOfSale) {
