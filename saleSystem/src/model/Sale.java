...
public class Sale {
	...
	/**
	 * Attempts to search and add an item as specified in the requestedItemDTO from the inventorySystem to an active sale.
	 * 
	 * @param inventorySystem The <code>InventorySystem</code> containing all items.
	 * @param requestedItemDTO The <code>RequestedItemDTO</code> containing the specifications of the item to add.
	 * 
	...
	/**
	 * Checks the passed {@link DiscountDatabase} for potential discounts and adds the total discount to the sale.
	 * 
	 * @param discountDatabase The database to search for discounts.
	 * @param customerID The customer ID which is passed on to discountDatabase.
	 * 
	...
	/**
	 * Accepts a payment and creates a payment and receipt object, receives the total change from payment and returns this value.
	 * 
