...
class SaleOptions {
	...
	SaleOptions(SaleSystemFrame saleSystemFrame, Controller contr, BoundsDTO boundsDTO) {
	...
	private class NewSaleButtonListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent e) {
			contr.newSale();
			saleSystemFrame.switchToItemInput();
		}
	}
	...
	private class CheckDiscountButtonListener implements ActionListener {
		@Override
		public void actionPerformed(ActionEvent e) {
			saleSystemFrame.switchToDiscountInput();
		}
	}
