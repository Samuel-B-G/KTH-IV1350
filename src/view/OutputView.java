...
import controller.ExceptionObserver;
import model.ItemAndRunningTotalDTO;
import model.SaleObserver;

class OutputView implements SaleObserver, ExceptionObserver {
	...
	/**
	 * Displays the message from a caught exception on in the generalMessage label.
	 */
