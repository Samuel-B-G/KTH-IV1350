...
class DiscountInputView {
	...
	DiscountInputView(Controller contr, SaleSystemFrame saleSystemFrame, BoundsDTO boundsDTO) {
		this.contr = contr;
	...
	private void checkDiscount() throws OperationFailedException, NoActiveSaleException {
